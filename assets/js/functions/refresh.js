...
const deleteThis = require('./deleteThis');

module.exports = {

    HTMLnCache: function(tempIndexFnc) {
        ...
        while(localStorage.getItem(`task-${tempIndexFnc+1}`)) { // While exists NextTask, keep reorganizing it.
            let tempButtonDelete = create.buttonDelete(tempIndexFnc); // Create button equal of deleted task button.
            ...
            create.paragraph(tempButtonDelete, `${tempNextTaskValue} `, tempIndexFnc); /* Create again the paragraph of deleted task
